  ...
  featured: [
    {
      ...
      image: 'assets/featured/tempo-slider.png',
      body:
...
新機能: 3バンドアイソレーター（LOW / MID / HIGH）をコントロールパネルに搭載しました。テンポフェーダーの隣に常時表示され、各バンドを下げてカット/キル、上げて +6dB ブーストできます（DJ ミキサーのアイソレーターと同じ操作感）。3バンドすべてを下げきると音を完全に無音にできます。バンドごとに ON/OFF トグルと DJM 風の目盛り付き。ノブをダブルクリックすると 0dB に戻せます。`,
  ...
  schedule: [
    ...
    { date: '2026-09-09', title: 'WTW', venue: 'WOMB', city: 'Tokyo', type: 'dj',
      ...
      links: [{ label: 'Info', url: 'https://www.womb.co.jp/ja/events/090926' }] },
    { date: '2026-09-18', title: 'solfa 18TH ANNIVERSARY -DAY1-', venue: 'solfa', city: 'Tokyo', type: 'dj', note: 'as Traks Boys',
      ...
      links: [{ label: 'Info', url: 'https://nakameguro-solfa.com/events/solfa-18th-anniversary-day1/' }] },
